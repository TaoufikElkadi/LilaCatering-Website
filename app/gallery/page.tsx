...
export default function Gallery() {
  ...
  const categories = [
    ...
    { id: 'dishes' as const, name: 'Dishes', icon: '🍽️' },
    { id: 'events' as const, name: 'Events', icon: '🎉' },
    { id: 'decor' as const, name: 'Decor', icon: '✨' },
  ];
      ...
      <section className="relative h-[50vh] bg-gradient-to-br from-primary-charcoal to-primary-black flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-5xl md:text-7xl font-serif font-bold mb-6">
            <span className="text-accent-gold">Our Gallery</span>
          </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">
              <span className="text-accent-gold">Make Your Event</span>
              <br />
              <span className="text-primary-white">Gallery-Worthy</span>
            </h2>
